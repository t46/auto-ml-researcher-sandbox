...
from utils.my_prompt2model.generate_hypothetical_document import generate_hypothetical_model_description
...
class DescriptionModelRetriever(ModelRetriever):
    ...
    def retrieve(
        ...
        if self.use_bm25:
            ...
            results = search_engine.search(query_text, cutoff=self.first_stage_depth)  # TODO: ここと互換性があるようにしてあげれば他のライブラリのBM25も使えるかも
